...
const AddAlatItem = ({ errors }) => {
    ...
    const [tambah, setTambah] = useState(5)
                    ...
                    <div className="card">
                        <div className="grid lg:grid-cols-4">
                            <div className="lg:col-span-2 col-span-4 form-control m-2">
                                ...
                                <input type="text" placeholder="Nama Alat" className="input input-bordered w-full" value={name} onChange={(name) => setName(name.target.value)} />
                                <label className="label">
                                    {errors.name &&
                            ...
                            <div className="lg:col-span-1 col-span-2 form-control m-2">
                                ...
                                <input type="text" value={total} onChange={(total) => setTotal(total.target.value)} placeholder="Total Alat" className="input input-bordered  w-full" />
                                <label className="label">
                                    {errors.total &&
